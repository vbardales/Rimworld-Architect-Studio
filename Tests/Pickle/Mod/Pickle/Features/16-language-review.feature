...
#
# What this cannot carry, and what therefore stays manual: the language switch itself, which needs
# RimWorld restarted between English and French, and the restart half of the accented-category
# check, where the binding is regenerated by the game at startup rather than by the editor.
@review
