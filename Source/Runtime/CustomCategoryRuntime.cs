...
namespace ArchitectStudio
{
    ...
    public static class CustomCategoryRuntime
    {
        ...
        private static void EnsureKeyBindingCategory(DesignationCategoryDef category)
        {
            ...
            var binding = category.bindingCatDef ?? DefDatabase<KeyBindingCategoryDef>.GetNamedSilentFail(defName);
            if (binding == null)
            {
            ...
            // Refresh existing bindings too, including those generated by the game at startup.
            binding.label = "ArchitectStudio.KeyBindings.CategoryLabel".Translate(category.LabelCap);
            binding.description = "ArchitectStudio.KeyBindings.CategoryDescription".Translate(category.LabelCap);
