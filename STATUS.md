...
remaining:
  ...
  - external: the Pickle defect behind that scenario is fixed on `fix/tag-rect-interface-scale`, 541f927 in the fork at github.com/vbardales/Rimworld-Pickle, not merged to its main nor sent to RimWorks; a Workshop Pickle still sends the pointer off screen at 150%
...
list: the fix has not reached RimWorks — it is `fix/tag-rect-interface-scale`, 541f927 in the fork
